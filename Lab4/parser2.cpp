...
int main() {
    ...
    addToParsingTable('S', '(', "TE");
    addToParsingTable('S', 'i', "TE");
    addToParsingTable('E', '+', "+TE");
    addToParsingTable('E', '$', "e"); // For the empty string
    addToParsingTable('T', '(', "FR");
    addToParsingTable('T', 'i', "FR");
    addToParsingTable('R', '+', "e"); // For the empty string
    addToParsingTable('R', '*', "*FR");
    addToParsingTable('R', ')', "e"); // For the empty string
    addToParsingTable('R', '$', "e"); // For the empty string
    addToParsingTable('F', '(', "(S)");
    addToParsingTable('F', 'i', "i");


    // Parse the input string
    string input = "i*i+i$"; // Append $ to the end to indicate the end of the input
    vector<char> stack;
    stack.push_back('$');
